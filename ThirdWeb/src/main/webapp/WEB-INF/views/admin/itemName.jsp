		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
				    <li  class="active"><a href="/admin/itemName">Item Name</a><span
...
<!-- 					тут все так само як на сервлетах -->
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/itemName/update/${itemName.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/itemName/delete/${itemName.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
